...
class Edge {
  ...
  // priorityQueue - specialized form of a min-heap, where the priority of a piece of data is stored alongside data, and elements are popped based on the priority value
  class PriorityQueue {
    constructor() {
      this.heap = [null];
      this.size = 0;
  ...
  // dijkstras - finds the shortest diistances between vertices
